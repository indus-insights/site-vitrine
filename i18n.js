...
(function () {
  ...
  const T = {
    fr: {
      ...
      feat1_d: "Pas un modèle générique adapté à la va-vite. Chaque indicateur et chaque vue sont pensés pour vos opérations et votre vocabulaire.",
      feat2_d: "Excel, Google Sheets, vos exports : le tableau de bord lit vos fichiers là où ils sont. Vos équipes ne changent rien à leur façon de saisir.",
      feat3_d: "Vous saisissez des données brutes, le tableau de bord calcule le reste : taux, écarts, moyennes, tendances. Plus aucune formule à maintenir à la main.",
      feat4_d: "Vert, orange, rouge selon vos propres limites. Vous fixez les seuils dans votre fichier, sans m'appeler, et l'affichage se met à jour.",
      feat5_d: "Un seuil dépassé déclenche une alerte automatique. Et un rapport de synthèse part à qui vous voulez, au rythme choisi (chaque lundi, par exemple).",
      feat6_d: "Chaque jour, l'état de vos indicateurs est enregistré. Vous suivez l'évolution sur 30, 60 ou 90 jours et repérez les dérives avant qu'elles ne s'installent.",
      feat7_d: "Le même tableau de bord en français, anglais et allemand, d'un clic. Pratique pour une équipe internationale ou une maison mère à l'étranger.",
      feat8_d: "Ordinateur, tablette, smartphone, écran d'atelier : l'affichage s'adapte. Vos chiffres vous suivent partout.",
      feat9_d: "Un affichage épuré, pensé pour un écran mural en atelier ou en salle de réunion. Les indicateurs clés restent visibles de loin.",
      ...
      tarifs_p1: "Tout commence par une journée passée ensemble, sur place, pour <strong>découvrir votre activité</strong> et <strong>analyser vos besoins</strong>. Cet audit est à 490 €, <strong>déduits</strong> du projet si vous décidez de lancer un tableau de bord. Le projet de pilotage est ensuite un <strong>forfait sur mesure</strong>, défini selon votre contexte.",
      tarifs_p2: "Ensuite, l'hébergement, la maintenance et les évolutions sont <strong>assurés par abonnement</strong>, à partir de 100 € par mois et par tableau de bord. Le détail des formules (cloud ou sur vos serveurs, avec ou sans assistant IA) est présenté dans la brochure, sur simple demande.",
    ...
    en: {
      ...
      sheet_r1: "Start_Date",
      sheet_r2: "Planned_End",
      sheet_r3: "Forecast_End",
      sheet_r4: "Tasks_Total",
      sheet_r5: "Tasks_Done",

      features_eyebrow: "Features",
      feat1_d: "Not a generic template tweaked in a hurry. Every indicator and every view is designed for your operations and your vocabulary.",
      feat2_d: "Excel, Google Sheets, your exports: the dashboard reads your files where they are. Your teams change nothing in how they enter data.",
      feat3_d: "You enter raw data, the dashboard computes the rest: rates, variances, averages, trends. No more formulas to maintain by hand.",
      feat4_d: "Green, amber, red based on your own limits. You set the thresholds in your file, without calling me, and the display updates.",
      feat5_d: "A breached threshold triggers an automatic alert. And a summary report goes to whoever you want, at the chosen pace (every Monday, for example).",
      feat6_d: "Every day, the state of your indicators is recorded. You track the evolution over 30, 60 or 90 days and spot drifts before they settle in.",
      feat7_d: "The same dashboard in French, English and German, in one click. Handy for an international team or a parent company abroad.",
      feat8_d: "Computer, tablet, smartphone, workshop screen: the display adapts. Your figures follow you everywhere.",
      feat9_d: "A clean display, designed for a wall screen in the workshop or meeting room. Key indicators stay readable from afar.",
      ...
      tarifs_p1: "It all starts with a day spent together, on site, to <strong>discover your business</strong> and <strong>analyse your needs</strong>. This audit costs €490, <strong>deducted</strong> from the project if you decide to launch a dashboard. The steering project is then a <strong>tailored package</strong>, defined according to your context.",
      tarifs_p2: "Then hosting, maintenance and improvements are <strong>covered by subscription</strong>, from €100 per month and per dashboard. The detail of the plans (cloud or on your servers, with or without AI assistant) is in the brochure, on request.",
    ...
    de: {
      ...
      hero_lead: "Ich helfe Industrie-KMU, ihre Produktion, Instandhaltung und Projekte mit ihren eigenen Zahlen zu steuern. Lass uns zusammenarbeiten!",
      hero_cta: "Lassen Sie uns 30 Minuten sprechen",
      ...
      step2_detail: "Wir bringen diese Daten in ein sauberes, verlässliches Format und legen Zuständigkeiten und Aktualisierungsprozesse fest.",
      step3_title: "Sie steuern",
      step3_aria: "Sie steuern",
      step3_detail: "Wir steuern ein maßgeschneidertes Dashboard, das sich automatisch aktualisiert und Abweichungen meldet, sobald sie auftreten.",
      ...
      solution_legend: "Ihre Teams geben Rohdaten in eine Software ein, die sie bereits kennen.<br />Das Dashboard erledigt den Rest, automatisch.",

      why1_q: "Warum sollten Ihre Daten strukturiert werden?",
      ...
      why2_a: "Die wichtigen, hervorgehobenen und stets aktuellen Zahlen ermöglichen es Ihnen, sofort Entscheidungen zu treffen.",
      ...
      feat2: "Mit Ihren bestehenden Daten verbunden",
      ...
      sheet_file: "Projektverfolgung.xlsx",
      sheet_r1: "Start_Datum",
      sheet_r2: "Geplantes_Ende",
      sheet_r3: "Prognose_Ende",
      sheet_r4: "Aufgaben_Gesamt",
      sheet_r5: "Aufgaben_Erledigt",

      features_eyebrow: "Funktionen",
      feat1_d: "Keine schnell angepasste Standardvorlage. Jede Kennzahl und jede Ansicht ist auf Ihren Betrieb und Ihre Begriffe zugeschnitten.",
      feat2_d: "Excel, Google Sheets, Ihre Exporte: Das Dashboard liest Ihre Dateien dort, wo sie liegen. Ihre Teams ändern nichts an ihrer Eingabe.",
      feat3_d: "Sie geben Rohdaten ein, das Dashboard berechnet den Rest: Quoten, Abweichungen, Mittelwerte, Trends. Keine Formeln mehr von Hand zu pflegen.",
      feat4_d: "Grün, Orange, Rot nach Ihren eigenen Grenzwerten. Sie legen die Schwellen in Ihrer Datei fest, ohne mich anzurufen, und die Anzeige aktualisiert sich.",
      feat5_d: "Eine überschrittene Schwelle löst einen automatischen Alarm aus. Und ein Übersichtsbericht geht an wen Sie wollen, im gewählten Rhythmus (z. B. jeden Montag).",
      feat6_d: "Jeden Tag wird der Stand Ihrer Kennzahlen gespeichert. Sie verfolgen die Entwicklung über 30, 60 oder 90 Tage und erkennen Abweichungen, bevor sie sich festsetzen.",
      feat7_d: "Dasselbe Dashboard auf Französisch, Englisch und Deutsch, mit einem Klick. Praktisch für ein internationales Team oder eine Muttergesellschaft im Ausland.",
      feat8_d: "Computer, Tablet, Smartphone, Werkstattbildschirm: Die Anzeige passt sich an. Ihre Zahlen begleiten Sie überall.",
      feat9_d: "Eine klare Anzeige, gedacht für einen Wandbildschirm in Werkstatt oder Besprechungsraum. Wichtige Kennzahlen bleiben aus der Ferne lesbar.",
      ...
      demo_desc: "Auf Anfrage gebe ich Ihnen interaktiven Zugriff auf eines dieser Demo-Dashboards und auf die Datenquelle (Google Sheets), die es speist. Ändern Sie eine Zelle, das Dashboard aktualisiert sich. Sie werden sehen, wie einfach es ist.",
      ...
      tarifs_p1: "Alles beginnt mit einem gemeinsamen Tag bei Ihnen vor Ort, um <strong>Ihre Tätigkeit kennenzulernen</strong> und <strong>Ihren Bedarf zu analysieren</strong>. Dieses Audit kostet 490 €, die bei Beauftragung eines Dashboards <strong>angerechnet</strong> werden. Das Steuerungsprojekt ist dann ein <strong>maßgeschneidertes Paket</strong>, je nach Kontext.",
      tarifs_p2: "Hosting, Wartung und Weiterentwicklungen werden anschließend <strong>per Abonnement abgedeckt</strong>, ab 100 € pro Monat und pro Dashboard. Die Details der Pakete (Cloud oder auf Ihren Servern, mit oder ohne KI-Assistent) finden Sie in der Broschüre, auf Anfrage.",
      ...
      about_p2: "Bei Nexans Hannover habe ich Prozesse optimiert und die Dashboards gebaut, die zur täglichen Steuerung des Betriebs dienten. Zuvor bei EDF im kerntechnischen Bauwesen: Zuverlässigkeitsstudien an Betonstrukturen. Was ich anbiete, habe ich zuerst in der Praxis gemacht.",
