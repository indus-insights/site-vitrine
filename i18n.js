...
(function () {
  ...
  const T = {
    fr: {
      ...
      hero_lead: "J'aide les TPE et PME à organiser leurs données et à construire des dashboards sur-mesure pour piloter leur activité avec une vue claire, adaptée à leur métier.",
      ...
      instruments_callout: "Ces dashboards ne sont pas des rapports à produire en fin de mois. Ce sont des instruments de pilotage qui lisent vos fichiers en continu et signalent les écarts dès qu'ils apparaissent.",

      feature1_title: "Connecté en temps réel à vos sources existantes",
      feature1_desc: "Google Sheets, Excel local ou OneDrive/SharePoint, ERP, API. Vous saisissez, le dashboard se met à jour. Vos données restent dans vos fichiers, rien n'est copié ailleurs.",
      feature2_title: "Indicateurs calculés automatiquement",
      feature2_desc: "Vous ne remplissez que les données brutes. Tous les calculs (moyennes, ratios, agrégations, alertes) sont produits automatiquement côté serveur.",
      ...
      feature7_desc: "Vert, orange, rouge selon vos règles métier. Les seuils et les cibles sont définis dans votre fichier, modifiables à tout moment sans intervention technique.",
      ...
      feature9_desc: "Le dashboard enregistre vos indicateurs chaque jour et affiche leur évolution sur 30, 60 ou 90 jours. Vous voyez les tendances de fond, pas seulement l'instantané.",
      ...
      pourquoi_intro: "Power BI, Monday, Jira - ces outils couvrent les cas généraux. Dès qu'on veut un vrai outil de pilotage métier, taillé à vos KPIs, ils montrent leurs limites.",
      pbi_section: "Power BI / Tableau",
      card1_title: "Customisation visuelle bridée",
      card1_desc: "Feux signaux conditionnels impossibles nativement, layout rigide, TV mode non pensé pour l'atelier. Pour chacun de ces cas, il faut bidouiller avec des visuels externes ou du DAX.",
      ...
      card3_desc: "KPIs métier (OEE, MTBF, alertes conditionnelles), drilldowns personnalisés, intégration GMAO : tout ça demande du DAX avancé ou Power Automate. Simple pour un bar chart, pas pour un vrai outil de pilotage.",
      ...
      monday1_intro: "Monday et Jira gèrent des tâches. Leurs widgets de reporting ignorent les formules complexes.",
      ...
      monday2_desc: "Monday et Jira imposent que tout soit saisi dans leur outil. Migration de données, reconfiguration, nouvelles habitudes pour toute l'équipe.",
      ...
      pull_quote: "Ces outils sont conçus pour des millions d'usages différents. Un dashboard sur-mesure est conçu pour un seul : le vôtre.",
    ...
    en: {
      ...
      instruments_callout: "These dashboards are not reports to produce at month-end. They are monitoring instruments that read your files continuously and signal deviations as soon as they appear.",

      feature1_title: "Connected in real time to your existing sources",
      feature1_desc: "Google Sheets, local Excel or OneDrive/SharePoint, ERP, APIs. You enter the data, the dashboard updates. Your data stays in your files, nothing is copied elsewhere.",
      feature2_title: "Indicators calculated automatically",
      feature2_desc: "You only fill in the raw data. All calculations (averages, ratios, aggregations, alerts) are produced automatically server-side.",
      ...
      feature7_desc: "Green, orange, red based on your business rules. Thresholds and targets are defined in your file, adjustable at any time without technical intervention.",
      feature8_title: "Automatic email alerts and reports",
      feature8_desc: "As soon as an indicator crosses a critical threshold, you get an email. And every week, a summary lands in your inbox automatically. The dashboard alerts you, even when no one is watching it.",
      feature9_title: "History and trends",
      feature9_desc: "The dashboard records your indicators every day and shows their evolution over 30, 60 or 90 days. You see the underlying trends, not just the snapshot.",
      ...
      card1_desc: "Conditional traffic-light indicators impossible natively, rigid layout, TV mode not designed for workshop screens. For each of these cases, you have to hack around with external visuals or DAX.",
      ...
      card3_desc: "Business KPIs (OEE, MTBF, conditional alerts), custom drilldowns, CMMS integration: all of this requires advanced DAX or Power Automate. Simple for a bar chart, not for a real monitoring tool.",
      card3_tag: "In custom: business needs are coded once for all, no hacking.",
      monday_section: "Monday / Jira",
      monday1_title: "Real business KPIs",
      monday1_intro: "Monday and Jira manage tasks. Their reporting widgets ignore complex formulas.",
      ...
      monday2_desc: "Monday and Jira require everything to be entered in their tool. Data migration, reconfiguration, new habits for the whole team.",
